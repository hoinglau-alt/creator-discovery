...
// 通过 Cloudflare Worker 代理访问 YouTube API（绕过部署环境网络限制）
const YOUTUBE_PROXY_BASE = 'https://patient-dream-d433.hoing-lau.workers.dev';
const YOUTUBE_API_BASE = `${YOUTUBE_PROXY_BASE}/youtube/v3`;
