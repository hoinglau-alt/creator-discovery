...
const creatorTemplates: Omit<Creator, 'id' | 'evaluation' | 'growthData' | 'recentVideos'>[] = [
  ...
  { name: '遊戲宅HK', avatar: '', platform: 'youtube', platformHandle: '@gamergeekhk', region: 'hong_kong', categories: ['gaming', 'tech'], followers: 560000, followerTier: '50-100w', contentType: 'mid_long', contactInfo: [{ type: 'email', value: 'business@gamergeek.hk', reliability: 'high', source: 'YouTube About' }], outreachStatus: 'pending', languages: ['粤语', '普通话'], joinedDate: '2018-06', assignedTo: '王磊' },
  // YouTube - Taiwan
  ...
  { name: '寵物日常HK', avatar: '', platform: 'tiktok', platformHandle: '@petdailyhk', region: 'hong_kong', categories: ['pets', 'lifestyle'], followers: 680000, followerTier: '50-100w', contentType: 'short', contactInfo: [{ type: 'email', value: 'contact@petdaily.hk', reliability: 'high', source: 'TikTok Bio' }], outreachStatus: 'pending', languages: ['粤语', '普通话'], joinedDate: '2021-01', assignedTo: '未分配' },
  // TikTok - Taiwan
  ...
  { name: 'Anime Culture TW', avatar: '', platform: 'x', platformHandle: '@animeculture_tw', region: 'taiwan', categories: ['anime', 'entertainment'], followers: 190000, followerTier: '10-50w', contentType: 'short', contactInfo: [{ type: 'email', value: 'contact@animeculture.tw', reliability: 'high', source: 'X Bio' }], outreachStatus: 'pending', languages: ['普通话', '日语'], joinedDate: '2019-07', assignedTo: '未分配' },
  // X - Taiwan
